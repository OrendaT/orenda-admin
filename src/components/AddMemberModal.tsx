    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-base font-semibold text-gray-900">Invite New Member</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="space-y-4">
          ...
          <fieldset className="rounded-md mt-[1.5em]">
            <p className="text-sm mb-[1em]">Member role</p>
            {ROLE_OPTIONS.map((r) => (
              <div key={r}>
                <label
                ...
                >
                  ...
                  >
                    {selectedRole === r && <CheckIcon className="h-3 w-3 text-white" />}
                  </span>
