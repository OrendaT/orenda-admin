    ...
    <div className="w-full h-screen flex">
      <div className="flex-1 bg-gray-50 p-6 overflow-auto scrollbar-none">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-[clamp(1.5rem, 3vw + 0.75rem, 2.25rem)] font-semibold">Teams</h1>
          <Button
            onClick={() => setInviteOpen(true)}
            // style={{ width: '12rem' }}
            className="w-[clamp(6rem,50vw,12rem)] flex items-center justify-center bg-[#2E0086] hover:bg-[#25006D] text-white py-2 rounded-3xl text-md font-medium"
          >
            + New Member
          </Button>
        </div>
